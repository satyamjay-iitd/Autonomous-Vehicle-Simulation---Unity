...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class CarAIControl : MonoBehaviour
    {
        ...
        private CarMover _mCarMover;    // Reference to actual car controller we are controlling
        ...
        private void Awake()
        {
            ...
            _mCarMover = GetComponent<CarMover>();
        ...
        private void FixedUpdate()
        {
            if (m_Target == null || !m_Driving)
            {
                ...
                _mCarMover.Move(0, 0, -1f, 1f, false);
            }
            else
            {
                Vector3 fwd = transform.forward;
                if (m_Rigidbody.velocity.magnitude > _mCarMover.MaxSpeed*0.1f)
                {
                    fwd = m_Rigidbody.velocity;
                }

                float desiredSpeed = _mCarMover.MaxSpeed;
                    ...
                    case BrakeCondition.TargetDirectionDifference:
                        {
                            ...
                            desiredSpeed = Mathf.Lerp(_mCarMover.MaxSpeed, _mCarMover.MaxSpeed*m_CautiousSpeedFactor,
                ...
                float accelBrakeSensitivity = (desiredSpeed < _mCarMover.CurrentSpeed)
                                                  ? m_BrakeSensitivity
                                                  : m_AccelSensitivity;

                // decide the actual amount of accel/brake input to achieve desired speed.
                float accel = Mathf.Clamp((desiredSpeed - _mCarMover.CurrentSpeed)*accelBrakeSensitivity, -1, 1);
                ...
                float steer = Mathf.Clamp(targetAngle*m_SteerSensitivity, -1, 1)*Mathf.Sign(_mCarMover.CurrentSpeed);

                // feed input to the car controller.
                _mCarMover.Move(steer, accel, accel, 0f, false);
