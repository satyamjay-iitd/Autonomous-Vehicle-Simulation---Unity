...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    {
        public CarMover carMover; // car controller to get the steering angle
        ...
        private void Update()
        {
            transform.localRotation = m_OriginalRotation*Quaternion.Euler(0, carMover.CurrentSteerAngle, 0);
        }
    }
}
