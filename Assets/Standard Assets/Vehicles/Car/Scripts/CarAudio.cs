...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class CarAudio : MonoBehaviour
    {
        ...
        private CarMover _mCarMover; // Reference to car we are controlling
        ...
        private void Update()
        {
            ...
            if (m_StartedSound)
            {
                ...
                float pitch = ULerp(lowPitchMin, lowPitchMax, _mCarMover.Revs);
                ...
                else
                {
                    ...
                    float accFade = Mathf.Abs(_mCarMover.AccelInput);
                    float decFade = 1 - accFade;

                    // get the high fade value based on the cars revs
                    float highFade = Mathf.InverseLerp(0.2f, 0.8f, _mCarMover.Revs);
